...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let nav = document.createElement('nav');
    nav.style.backgroundColor = 'red'; // Make it visible for testing
    ...
    for (let p of pages) {
        ...
        nav.insertAdjacentHTML('beforeend', `<a href="${url}" style="color: white; margin: 0 10px;">${title}</a>`);
    }
    
    document.body.prepend(nav);
    console.log('Navigation should be visible now!');
});